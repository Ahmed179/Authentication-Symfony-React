...
require_once __DIR__.\DIRECTORY_SEPARATOR.'FirewallConfig'.\DIRECTORY_SEPARATOR.'LexikJwtConfig.php';
...
class FirewallConfig 
{
    ...
    public function lexikJwt(array $value = []): \Symfony\Config\Security\FirewallConfig\LexikJwtConfig
    {
        if (null === $this->lexikJwt) {
            $this->lexikJwt = new \Symfony\Config\Security\FirewallConfig\LexikJwtConfig($value);
        } elseif ([] !== $value) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (isset($value['lexik_jwt'])) {
            $this->lexikJwt = new \Symfony\Config\Security\FirewallConfig\LexikJwtConfig($value['lexik_jwt']);
